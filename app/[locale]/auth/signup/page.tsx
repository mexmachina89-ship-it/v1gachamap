      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-2xl border-4 border-pink-200 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-pink-400 via-purple-400 to-yellow-300 p-6 text-center">
            ...
            <h1 className="text-2xl font-black text-white mt-2 drop-shadow">{t("signupTitle")}</h1>
          </div>
          ...
          <div className="p-6">
            {success ? (
              <div className="text-center py-8">
                ...
                <p className="text-xl font-black text-green-600 mt-4">{t("registerSuccess")}</p>
                <p className="text-gray-500 mt-2 text-sm">
                  {locale === "ja" ? "ログイン画面に移動します..." : "Redirecting to sign in..."}
                </p>
              </div>
            ) : (
              <>
                ...
                <p className="text-center text-sm text-gray-500 mt-4">
                  ...
                  <Link href={`/${locale}/auth/signin`} className="text-pink-500 font-bold hover:underline">
                    {t("signinLink")}
                  </Link>
                </p>
              </>
